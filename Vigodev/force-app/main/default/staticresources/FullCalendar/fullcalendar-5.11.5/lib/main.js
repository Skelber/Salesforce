      ...
      SegHierarchy.prototype.toRects = function () {
        ...
        for (var level = 0; level < levelCnt; level += 1) {
          ...
          for (var _i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
            ...
            rects.push(
              __assign(__assign({}, entry), { levelCoord: levelCoord })
            );
          }
        }
        return rects;
        ...
        return createPortal(
          createElement(
            ...
            createElement(
              ...
              {
                className:
                  "fc-popover-header " + theme.getClass("popoverHeader"),
              },
              createElement(
                "span",
            ...
            createElement(
              ...
              {
                className:
                  "fc-popover-body " + theme.getClass("popoverContent"),
              },
              props.children
            )
          ),
              ...
              Boolean(props.moreCnt) &&
                createElement(
                  RenderHook,
                  {
                    ...
                    defaultContent:
                      props.defaultContent || renderMoreLinkInner$1,
